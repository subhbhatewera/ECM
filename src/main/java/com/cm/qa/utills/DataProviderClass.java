...
public class DataProviderClass extends TestBase {
	...
	public Object[][] getCategories() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - General Information.xlsx",
				"Category");
		return data;
	}
	...
	public Object[][] getTermData() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Term.xlsx", "Term");
		return data;
	}

	@DataProvider(name = "generalTerms")
	public Object[][] getGeneralTermsData() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Commercials.xlsx", "GeneralTerms");
		return data;
	}

	@DataProvider(name = "uom")
	public Object[][] getUOM() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Commercials.xlsx", "UOM");
		return data;
	}

	@DataProvider(name = "linkedOpportunity")
	public Object[][] getLinkedOpportunity() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Commercials.xlsx",
				"LinkedOpportunity");
		return data;
	}
	...
	public Object[][] getService() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Commercials.xlsx", "Service");
		return data;
	}

	@DataProvider(name = "subService")
	public Object[][] getSubService() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Commercials.xlsx", "SubService");
		return data;
	}

	@DataProvider(name = "project")
	public Object[][] getProject() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Commercials.xlsx", "Project");
		return data;
	}
	...
	public Object[][] getFixedFeeData() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Commercials.xlsx", "FixedFee");
		return data;
	}

	@DataProvider(name = "minimumBilling")
	public Object[][] getMinimumBillingData() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Commercials.xlsx", "MinimumBilling");
		return data;
	}

	@DataProvider(name = "editCommercials")
	public Object[][] getContractTitle() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Commercials.xlsx", "ContractTitle");
		return data;
	}

	@DataProvider(name = "cola")
	public Object[][] getCOLAData() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Other Commercials.xlsx", "COLA");
		return data;
	}

	@DataProvider(name = "incentive")
	public Object[][] getIncentiveData() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Other Commercials.xlsx",
				"Incentive");
		return data;
	}
	...
	public Object[][] getPenaltyData() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData- Other Commercials.xlsx", "Penalty");
		return data;
	}
	...
	public Object[][] getTATData() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - SLA.xlsx", "TAT");
		return data;
	}

	@DataProvider(name = "quality")
	public Object[][] getQualityData() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - SLA.xlsx", "Quality");
		return data;
	}

	@DataProvider(name = "upTime")
	public Object[][] getUptimeData() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - SLA.xlsx", "Uptime");
		return data;
	}

	@DataProvider(name = "addContactPerson")
	public Object[][] getAddContactPersonData() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Contact Persons.xlsx",
				"AddContactPersons");
		return data;
	}
	...
	public Object[][] getFunction() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Contact Persons.xlsx", "Function");
		return data;
	}

	@DataProvider(name = "userName")
	public Object[][] getUserName() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Profile.xlsx", "Username");
		return data;
	}

	@DataProvider(name = "invalidName")
	public Object[][] getInvalidName() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Profile.xlsx", "InvalidName");
		return data;
	}

	@DataProvider(name = "addNotification")
	public Object[][] getAddNotificationData() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Notification.xlsx",
				"AddNotification");
		return data;
	}
	...
	public Object[][] getDocumentsTabData() {
		Object data[][] = readDataFromFile(projectPath + "/src/main/java/resources/ECMTestData - Documents.xlsx", "Document");
		return data;
	}
